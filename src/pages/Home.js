...
<main>
      ...
      <div className="service-buttons"> <button>
    ...
    <section id="about">
      <div className="about-entry"> <img className="about-logo" src="../../public/assets/logo.png" alt=""/>
      ...
      </div> <img className="about-main-img" src={`${process.env.PUBLIC_URL}/assets/img3x4demo2.jpeg`} alt=""/>
    ...
    <section id="local">
      ...
      </div> <img className="local-main-img" src="../../public/assets/img3x4demo2.jpeg" alt=""/>
    </section>
</main>
  )
}