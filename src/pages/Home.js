...
<main>
      ...
      <div class="service-buttons"> <button>
          <p>Transplante Capilar</p><i class="fa-solid fa-arrow-right-long"></i>
        </button> <button>
          <p>Transplante Capilar</p><i class="fa-solid fa-arrow-right-long"></i>
        </button> <button>
          <p>Transplante Capilar</p><i class="fa-solid fa-arrow-right-long"></i>
    ...
    <section id="about">
      <div class="about-entry"> <img class="about-logo" src="../../public/assets/logo.png" alt=""/>
      ...
      </div> <img class="about-main-img" src="../../public/assets/img3x4demo2.jpeg" alt=""/>
      <div class="infobox">
        ...
        </p> <button>CONHEÇA AGORA <i class="fa-solid fa-arrow-right-long"></i></button>
      </div>
    </section>
    <section id="local">
      <div class="infobox">
        ...
        <button>CONHEÇA AGORA <i class="fa-solid fa-arrow-right-long"></i></button>
      </div> <img class="local-main-img" src="../../public/assets/img3x4demo2.jpeg" alt=""/>
    </section>
</main>
  )
}