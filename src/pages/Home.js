...
export default function Home() {
  return (
    <main>
      ...
      <section id="about">
        <div className="about-entry"> <img className="about-logo" src={`${process.env.PUBLIC_URL}/logo512.png`} alt="" />
      ...
      <section id="local">
        ...
        </div> <img className="local-main-img" src={`${process.env.PUBLIC_URL}/assets/img3x4demo2.jpeg`} alt="" />
      </section>
    </main>
  )
}