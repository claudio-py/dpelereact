...
return(
  <nav id="navigation">
      <div className="wrapper">
        ...
        </div> <button onClick={openMenu} className="open-menu"> <svg width="40" height="40" viewBox="0 0 40 40"
        ...
        <div className="div-wpp-icon"> <svg className="wpp-icon" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              fill="#FFFAF1" </path>
          </svg> </div> <button onClick={closeMenu} className="close-menu"> <svg width="40" height="40"
