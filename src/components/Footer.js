        ...
        <div className="last-footer">
          ...
          <div>
            ...
            <ul className="social-links">
              <li>
                <a href="#">
                  <img className='svg' src={`${process.env.PUBLIC_URL}/assets/insta.svg`} />
                </a>
              </li>
              <li>
                <a href="# ">
                  <img className='svg' src={`${process.env.PUBLIC_URL}/assets/face.svg`} />
                </a>
              </li>
              <li>
                <a href="# ">
                  <img className='svg' src={`${process.env.PUBLIC_URL}/assets/you.svg`} />
                </a>
              </li>
            </ul>
          </div>
